        ...
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              ...
              {!collapsed && (
                <span className="flex-1 text-left animate-slide-in">{item.label}</span>
              )}
              
              {!collapsed && item.badge && (
                <span className="animate-fade-in-up px-2 py-0.5 text-[10px] font-semibold bg-indigo-100 text-indigo-700 rounded-full">
                  {item.badge}
                </span>
              )}
              
              {collapsed && item.badge && (
                <span className="absolute -top-0.5 -right-0.5 w-4 h-4 text-[9px] font-semibold bg-indigo-500 text-white rounded-full flex items-center justify-center">
                  {item.badge}
                </span>
              )}
